<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="HopDungDongHo.aspx.cs" Inherits="ShopWatch.HopDungDongHo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="text-align:center;">
        <asp:HyperLink ID="HyperLink1" CssClass="link" NavigateUrl="~/HopDungDongHo.aspx?max=1000000" runat="server">Dưới 1 triệu</asp:HyperLink>
        <asp:HyperLink ID="HyperLink2" CssClass="link" NavigateUrl="~/HopDungDongHo.aspx?min=1000000&max=3000000" runat="server">Từ 1 triệu - 3 triệu</asp:HyperLink>
        <asp:HyperLink ID="HyperLink3" CssClass="link" NavigateUrl="~/HopDungDongHo.aspx?min=3000000&max=5000000" runat="server">Từ 3 triệu - 5 triệu</asp:HyperLink>
        <asp:HyperLink ID="HyperLink4" CssClass="link" NavigateUrl="~/HopDungDongHo.aspx?min=5000000&max=7000000" runat="server">Từ 5 triệu - 7 triệu</asp:HyperLink>
        <asp:HyperLink ID="HyperLink5" CssClass="link" NavigateUrl="~/HopDungDongHo.aspx?min=7000000" runat="server">Trên 7 triệu</asp:HyperLink>
    </div>
    <br />
    <asp:DataList ID="dlHop" RepeatColumns="4" runat="server">
        <ItemTemplate>
