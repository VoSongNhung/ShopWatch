<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminPage.Master" AutoEventWireup="true" CodeBehind="UpdateWatch.aspx.cs" Inherits="ShopWatch.Admin.UpdateWatch" %>
    ...
    <table cellpadding="0" cellspacing="0" class="tb">
        ...
        <tr>
            <td colspan="2">
                ...
                <asp:Button ID="Button1" runat="server"  Text="Sửa" style="width:100px;height:50px;background-color:blue;color:white;" OnClick="Button1_Click" />
