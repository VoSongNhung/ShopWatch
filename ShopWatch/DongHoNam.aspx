<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="DongHoNam.aspx.cs" Inherits="ShopWatch.DongHoNam" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
    <asp:DataList ID="dlNam" RepeatColumns="4" runat="server">
        <ItemTemplate>
